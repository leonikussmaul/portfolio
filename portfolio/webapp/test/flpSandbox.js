		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#myportfolioportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myportfolioportfolio-display": {
								"semanticObject": "myportfolioportfolio",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myportfolio.portfolio",
									"url": sap.ui.require.toUrl("myportfolio/portfolio")
								}
							}
						}
					}
