  ...
  function (BaseController, library, Fragment, formatter, Filter, FilterOperator, FilterType, UIComponent, JSONModel, MessageToast, MessageBox) {
    ...
    return BaseController.extend("myportfolio.portfolio.controller.App", {
      ...
      onInit() {
        ...
        const oData = {
          "aboutMe": "<u>Hello there, it's a pleasure to meet you!</u><br> I'm Leoni, and I'm thrilled to showcase <strong>my passion for UX and UI</strong> development through this app.<br><br>My journey into the tech world started in San Francisco, where I was captivated by its boundless opportunities. Through a couple of enriching internships, I delved deeper into this exciting field, eventually leading me to pursue a <strong>degree in Marketing & Design</strong> in the vibrant city of London.<br><br>Fast forward a few years, and I now find myself <strong>at SAP</strong>, specializing in App Development with our <strong>Cloud Platform, BTP </strong> (which, by the way, this app was built on as well!).<br><br>What truly drives me now is my enthusiasm for <strong>Human Computer Interaction</strong>, User-Centered Design, and Cognitive Psychology. With an <strong>international education</strong> and a multicultural background originating from Germany and Croatia, I'm eager to infuse my projects with a fresh and <strong>innovative perspective</strong>.<br><br>When I'm not coding and designing, you can find me indulging in my favorite hobbies like yoga, drawing, cooking, and hanging out with friends. I believe in creating, inspiring, and collaborating, so please don't hesitate to <strong>reach out if you have any cool ideas or feedback!</strong> 😄🚀"
